...
@Description(name = "ConcatStrings", value = "_FUNC_(str, delimiter)- Aggregate function, concat all value with specified delimiter.")
public class ConcatStrings extends UDAF {

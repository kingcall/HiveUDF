...
public final class IPLocator {
    ...
    public static IPLocator loadFromLocal(String filePath) throws IOException {
    ...
    public static IPLocator loadFromStream(InputStream in) throws Exception {
    ...
    public static IPLocator loadBinary(byte[] ipdb) {
        return new IPLocator(ipdb);
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            IPLocator l = loadFromLocal(args[0]);
